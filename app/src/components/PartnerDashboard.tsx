      ...
      <div className="max-w-7xl mx-auto space-y-13">
        ...
        {activeStep == 6 &&
          (vehicleData?.status === "rejected" ? (
            <RejectionCard
              title="Pricing & Vehicle Photo Rejected"
              reason={vehicleData?.rejectionReason}
              actionLabel="Update Pricing & Photo"
        ...
        {activeStep == 8 && (
          <motion.div
            ...
            className="bg-black text-white rounded-3xl p-10 shadow-2xl border border-gray-300"
          >
            <h2 className="text-2xl font-bold">🚀 You're Live</h2>
            <p>
              Your partner account is now active. You can now receive ride
              requests and start earning.
            </p>
            <button
              onClick={() => router.push("/user/book")}
              className="bg-white mt-4 text-black font-medium px-6 py-3 rounded-full flex items-center gap-2 hover:bg-gray-100 transition-all active:scale-95 shadow-md cursor-pointer"
            >

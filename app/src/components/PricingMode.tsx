...
const PricingMode = ({ open, onClose, data, onSuccess }: PropsType) => {
          ...
          >
            ...
            <div className="p-4 sm:p-6 space-y-4 sm:space-y-5 overflow-y-auto flex-1">
              {data?.status === "rejected" && data?.rejectionReason && (
                <div className="bg-red-50 border border-red-200 rounded-2xl p-4 text-xs sm:text-sm text-red-800 space-y-1">
                  <div className="flex items-center gap-2 font-bold text-red-700">
                    <XCircle size={16} />
                    Previous Submission Rejected
                  </div>
                  <p className="font-medium text-red-900 whitespace-pre-line pl-6">
